...
class DerivedArtifactType(str, Enum):
    ...
    EVENT_FRAGMENT_PROFILES = "event_fragment_profiles"
    EVENT_FRAGMENT_PAIR_CANDIDATES = "event_fragment_pair_candidates"
    EVENT_FRAGMENT_CLUSTER_PROPOSALS = "event_fragment_cluster_proposals"
    EVENT_FRAGMENT_CLUSTER_REVIEW = "event_fragment_cluster_review"
    OTHER = "other"
...
class ArticleTextProjectionConflict(ValueError):
    """Raised when derived text cannot safely populate a legacy article."""
